...
@protocol SimplePingTestDelegate;

/*! Controls the IP address version used by SimplePing instances.
 */

typedef NS_ENUM(NSInteger, SimplePingTestAddressStyle) {
...
@interface SimplePingTest : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<SimplePingTestDelegate> delegate;

/*! Controls the IP address version used by the object.
 *  \details You should set this value before starting the object.
 */

@property (nonatomic, assign, readwrite) SimplePingTestAddressStyle addressStyle;
...
@protocol SimplePingTestDelegate <NSObject>
...
- (void)simplePing:(SimplePingTest *)pinger didStartWithAddress:(NSData *)address;
...
- (void)simplePing:(SimplePingTest *)pinger didFailWithError:(NSError *)error;
...
- (void)simplePing:(SimplePingTest *)pinger didSendPacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber;
...
- (void)simplePing:(SimplePingTest *)pinger didFailToSendPacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber error:(NSError *)error;
...
- (void)simplePing:(SimplePingTest *)pinger didReceivePingResponsePacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber;
...
- (void)simplePing:(SimplePingTest *)pinger didReceiveUnexpectedPacket:(NSData *)packet;
